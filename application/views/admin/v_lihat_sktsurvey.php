...
<div class="row">
    ...
    <div class="col-xs-12">
          ...
          <div class="col-sm-9 col-sm-offset-2" style="width:960px">
...
<?php if(isset($dt_survey)){ foreach($dt_survey as $row){ ?>
  ...
  <tr>
    ...
    <td width="764"><p style="font-size:32px;text-align:center;line-height:1"><strong>PEMERINTAH   KOTA   BANDUNG </strong></p>
    <p style="font-size:24px;text-align:center;line-height:1"><strong>BADAN KESATUAN BANGSA </strong></p>
  <p style="font-size:24px;text-align:center;line-height:1"><strong>DAN PEMBERDAYAAN MASYARAKAT </strong></p>
  <p style="font-size:14px;text-align:center;line-height:1">Jalan Wastukencana No.2 Tlp. 022.4230393, 4230097 - Bandung</p></td>
  </tr>
